...
#pacman images
man0 = pygame.image.load("./Pacman Drawings/man0.png")
man1 = pygame.image.load("./Pacman Drawings/man1.png")
man2 = pygame.image.load("./Pacman Drawings/man2.png")
man3 = pygame.image.load("./Pacman Drawings/man3.png")

#clyde images
clyde_up = pygame.image.load("./Pacman Drawings/clyde_up.png")
clyde_down = pygame.image.load("./Pacman Drawings/clyde_down.png")
clyde_left = pygame.image.load("./Pacman Drawings/clyde_left.png")
clyde_right = pygame.image.load("./Pacman Drawings/clyde_right.png")
clyde_legs = pygame.image.load("./Pacman Drawings/clyde_legs.png")

#cookie images
cookie0 = pygame.image.load("./Pacman Drawings/cookie0.png")
cookie1 = pygame.image.load("./Pacman Drawings/cookie1.png")
cookie2 = pygame.image.load("./Pacman Drawings/cookie2.png")

#---map images---
down = pygame.image.load("./Pacman Drawings/d.png")
top = pygame.image.load("./Pacman Drawings/t.png")
left = pygame.image.load("./Pacman Drawings/l.png")
right = pygame.image.load("./Pacman Drawings/r.png")

bordertop = pygame.image.load("./Pacman Drawings/bt.png")
borderdown = pygame.image.load("./Pacman Drawings/bd.png")
borderleft = pygame.image.load("./Pacman Drawings/bl.png")
borderright = pygame.image.load("./Pacman Drawings/br.png")

border1 = pygame.image.load("./Pacman Drawings/b1.png")
border2 = pygame.image.load("./Pacman Drawings/b2.png")
border3 = pygame.image.load("./Pacman Drawings/b3.png")
border4 = pygame.image.load("./Pacman Drawings/b4.png")

turn1 = pygame.image.load("./Pacman Drawings/1.png")
turn2 = pygame.image.load("./Pacman Drawings/2.png")
turn3 = pygame.image.load("./Pacman Drawings/3.png")
turn4 = pygame.image.load("./Pacman Drawings/4.png")

lturn1 = pygame.image.load("./Pacman Drawings/5.png")
lturn2 = pygame.image.load("./Pacman Drawings/6.png")
lturn3 = pygame.image.load("./Pacman Drawings/7.png")
lturn4 = pygame.image.load("./Pacman Drawings/8.png")

u = pygame.image.load("./Pacman Drawings/u.png")
v = pygame.image.load("./Pacman Drawings/v.png")
w = pygame.image.load("./Pacman Drawings/w.png")
x = pygame.image.load("./Pacman Drawings/x.png")
y = pygame.image.load("./Pacman Drawings/y.png")
z = pygame.image.load("./Pacman Drawings/z.png")

door = pygame.image.load("./Pacman Drawings/door.png")
#------------
...
def draw(i, j, s):
    ...
    if "b" in s:
        ...
        if 0 <= cookie_phase <= 4:
            cookie = cookie0
        elif 5 <= cookie_phase <=8:
            cookie = cookie1
        elif 9 <= cookie_phase <= 12:
            cookie = cookie2
        elif 13 <= cookie_phase <= 16:
            cookie = cookie1
...
while True:
    ...
    if clyde_i_change == -speed:
        clyde_blit = pygame.transform.scale(clyde_up, [20,20])
    if clyde_i_change == speed:
        clyde_blit = pygame.transform.scale(clyde_down, [20,20])
    if clyde_j_change == -speed:
        clyde_blit = pygame.transform.scale(clyde_left, [20,20])
    if clyde_j_change == speed:
        clyde_blit = pygame.transform.scale(clyde_right, [20,20])

    clyde_i += clyde_i_change
    clyde_j += clyde_j_change

    #clyde body
    clyde_rect = clyde_blit.get_rect()
    clyde_rect.center = (clyde_j * 12 + 32 +6, clyde_i * 12+6)
    screen.blit(clyde_blit, clyde_rect)

    #clyde legs
    clyde_phase += 1
    if 0 <= clyde_phase <= 4:
        clyde_legs_blit = pygame.transform.scale(clyde_legs, [20,20])
        clyde_legs_rect = clyde_legs.get_rect()
        clyde_legs_rect.center = (clyde_j * 12 + 32+3, clyde_i * 12+3)
        screen.blit(clyde_legs_blit, clyde_legs_rect)
    elif clyde_phase == 8:
        clyde_phase = 0
